...
public class SimpleTester {
    ...
    private static final String CONTAINER_ID = "ScoreTestProject_1.0.0-SNAPSHOT";
    ...
    public SimpleTester() {
        ...
        Person p = new Person();
        p.setName("abc");
        PMMLRequestData request = new PMMLRequestData("123", "ScoreCardTest");//createSimpleScorecardRequest("123", "Sample Score", 33.0, "SKYDIVER", "KN", true);
        ApplyPmmlModelCommand command = (ApplyPmmlModelCommand) ((CommandFactoryServiceImpl) commandsFactory).newApplyPmmlModel(request);
        command.setPackageName("com");
        command.addComplexInputObject(p);
